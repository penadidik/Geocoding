...
import project.penadidik.cleanarchitecture.domain.annotation.ExceptionType.Companion.ALERT
import project.penadidik.cleanarchitecture.domain.annotation.ExceptionType.Companion.DIALOG
import project.penadidik.cleanarchitecture.domain.annotation.ExceptionType.Companion.INLINE
import project.penadidik.cleanarchitecture.domain.annotation.ExceptionType.Companion.REDIRECT
import project.penadidik.cleanarchitecture.domain.annotation.ExceptionType.Companion.SNACK
import project.penadidik.cleanarchitecture.domain.annotation.ExceptionType.Companion.TOAST
