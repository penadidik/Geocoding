...
import project.penadidik.geocoding.domain.annotation.ExceptionType.Companion.ALERT
import project.penadidik.geocoding.domain.annotation.ExceptionType.Companion.DIALOG
import project.penadidik.geocoding.domain.annotation.ExceptionType.Companion.INLINE
import project.penadidik.geocoding.domain.annotation.ExceptionType.Companion.REDIRECT
import project.penadidik.geocoding.domain.annotation.ExceptionType.Companion.SNACK
import project.penadidik.geocoding.domain.annotation.ExceptionType.Companion.TOAST
