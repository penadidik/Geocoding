package project.penadidik.cleanarchitecture.data.remote.builder

import android.content.Context
import project.penadidik.cleanarchitecture.data.Constants
import project.penadidik.cleanarchitecture.data.R
import project.penadidik.cleanarchitecture.data.remote.factory.RxErrorHandlingCallAdapterFactory
...
class RetrofitBuilder @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    private var logEnable: Boolean = project.penadidik.cleanarchitecture.data.BuildConfig.DEBUG
