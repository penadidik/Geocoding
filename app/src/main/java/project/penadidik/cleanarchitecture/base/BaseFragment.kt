...
import project.penadidik.cleanarchitecture.domain.annotation.Action
import project.penadidik.cleanarchitecture.domain.annotation.Redirect
import project.penadidik.cleanarchitecture.extension.setVisible
import project.penadidik.cleanarchitecture.extension.showDialog
import project.penadidik.cleanarchitecture.util.Helper
    ...
    private fun subscriberException() {
        viewModel.run {
            ...
            checkConnection.observe(viewLifecycleOwner) {
                isNetworkAvailable.value = Helper.isNetworkAvailable(requireContext());
            }
